# -*- coding: utf-8 -*-
"""Publie une version de FileScanner sur le canal de mise a jour.
...
Ce que fait ce script, a partir d'un `npx tauri build` deja fait :
  ...
  Sur filescanner-app.heiphaistos.org/maj/ -- invisible pour le client, jamais
...
VPS_DIR = "/var/www/filescanner-maj"
BASE_URL = "https://filescanner-app.heiphaistos.org/maj"
PRODUIT = "FileScanner"
PREFIXE = "filescanner"
